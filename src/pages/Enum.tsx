...
export default function Enum() {
  ...
  const totales = useMemo(() => {
    const totalConFolio = withFolio.reduce((s, r) => s + r.monto, 0)
    const totalSinFolio = sinFolio.reduce((s, r) => s + r.monto, 0)
    const ganancia = withFolio.reduce((s, r) => s + (r.monto - autogenerado(r.kind)), 0)
      ...
      {loading ? (
        ...
        <>
          ...
          <input
            ...
            placeholder="Buscar por nombre, folio, estatus o método de pago…"
